...
/**
 * Test case for class HSE\HeModules\Controller\StudyprogramsController.
 *
 */
class StudyprogramsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \HSE\HeModules\Controller\StudyprogramsController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('HSE\\HeModules\\Controller\\StudyprogramsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllStudyprogramssFromRepositoryAndAssignsThemToView()
	{
		...
		$studyprogramsRepository = $this->getMock('HSE\\HeModules\\Domain\\Repository\\StudyprogramsRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$studyprograms = new \HSE\HeModules\Domain\Model\Studyprograms();
	...
	public function createActionAddsTheGivenStudyprogramsToStudyprogramsRepository()
	{
		...
		$studyprogramsRepository = $this->getMock('HSE\\HeModules\\Domain\\Repository\\StudyprogramsRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenStudyprogramsInStudyprogramsRepository()
	{
		...
		$studyprogramsRepository = $this->getMock('HSE\\HeModules\\Domain\\Repository\\StudyprogramsRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenStudyprogramsFromStudyprogramsRepository()
	{
		...
		$studyprogramsRepository = $this->getMock('HSE\\HeModules\\Domain\\Repository\\StudyprogramsRepository', array('remove'), array(), '', FALSE);
